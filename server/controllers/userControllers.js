...
export const getUserData = async (req, res) => {
    try {
        ...
        res.json({ success: true, user }) // <-- corrected
    } catch (error) {
        console.log(error)
...
export const updateUserData = async (req, res) => {
    try {
        ...
        if (tempUser.username !== username) {
            ...
            if (existingUser) {
                username = tempUser.username // don't overwrite if taken
            }
        }
...
export const sendConnectionRequest = async (req, res) => {
    try{
        ...
        if(!connection){
            ...
            return res.json({success: false, message: 'You are already connectes with this user'})
        }
