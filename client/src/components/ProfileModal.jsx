                    ...
                    <form className='space-y-4' onSubmit={handleSaveProfile}>
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                onChange={(e) => setEditForm({...editForm, profile_picture: target.files[0]})} />
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                onChange={(e) => setEditForm({...editForm, cover_photo: target.files[0]})} />
                        ...
                        <div>
                            <label htmlFor="block text-sm font-medium text-gray-700 mb-1">Name</label>
                        ...
                        <div>
                            <label htmlFor="block text-sm font-medium text-gray-700 mb-1">Username</label>
                            <input type="text" className='w-full p-3 border border-gray-200 rounded-lg'
                            placeholder='Please enter a username' onChange={(e) => setEditForm({...editForm, username: e.target.value})}
                            value={editForm.username} />
                        </div>
                        <div>
                            <label htmlFor="block text-sm font-medium text-gray-700 mb-1">Bio</label>
                        ...
                        <div>
                            <label htmlFor="block text-sm font-medium text-gray-700 mb-1">Location</label>
                            <input type="text" className='w-full p-3 border border-gray-200 rounded-lg'
                        ...
                        <div className='flex justify-end space-x-3 pt-6'>
                            ...
                            <button type='submit' className='px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600
